...
[Právo na digitální služby](https://www.egdilna.cz/pravo-na-digitalni-sluzby) je jeden ze základních mechanismů digitální veřejné správy. Umožňuje uplatnit právo na plně digitální interakci klienta s veřejnou správou tam, kde to dává smysl.
